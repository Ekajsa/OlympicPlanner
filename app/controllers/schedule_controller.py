...
def create_empty_base_schedule():
    ...
    schedule = [["",
                 "<div class='alpine'><img src='/static/img/olympic_img/alpine-skiing.svg'</div>",
                 "<div class='biathlon'><img src='/static/img/olympic_img/biathlon.svg'</div>",
                 "<div class='bobsleigh'><img src='/static/img/olympic_img/bobsleigh.svg'</div>",
                 "<div class='cross-country-skiing'><img src='/static/img/olympic_img/cross-country-skiing.svg'</div>",
                 "<div class='curling'><img src='/static/img/olympic_img/curling.svg'</div>",
                 "<div class='figure-skating'><img src='/static/img/olympic_img/figure-skating.svg'</div>",
                 "<div class='freestyle-skiing'><img src='/static/img/olympic_img/freestyle-skiing.svg'</div>",
                 "<div class='ice-hockey'><img src='/static/img/olympic_img/ice-hockey.svg'</div>",
                 "<div class='luge'><img src='/static/img/olympic_img/luge.svg'</div>",
                 "<div class='noc'><img src='/static/img/olympic_img/nordic-combined.svg'</div>",
                 "<div class='short-track'><img src='/static/img/olympic_img/short-track-speed-skating.svg'</div>",
                 "<div class='skeleton'><img src='/static/img/olympic_img/skeleton.svg'</div>",
                 "<div class='ski-jumping'><img src='/static/img/olympic_img/ski-jumping.svg'</div>",
                 "<div class='snowboard'><img src='/static/img/olympic_img/snowboard.svg'</div>",
                 "<div class='speed-skating'><img src='/static/img/olympic_img/speed-skating.svg'</div>",
                 "<div class='ceremony'><img src='/static/img/olympic_img/b2022-logo.svg'</div>"]]
