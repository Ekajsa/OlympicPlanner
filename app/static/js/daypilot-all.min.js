...
!function () {
    ...
    if ("undefined" == typeof DayPilot.$) {
        "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), DayPilot.$ = function (e) {
            ...
            if (o = e.childNodes) for (a = o.length, t = 0; t < a; t += 1) {
            ...
            var a = "object" == typeof e.data, r = e.data, o = e.method || (e.data ? "POST" : "GET"),
                n = e.success || function () {
                }, i = e.error || function () {
                }, d = e.url, l = e.contentType || (a ? "application/json" : "text/plain"), s = e.headers || {};
            t.open(o, d, !0), t.setRequestHeader("Content-type", l), DayPilot.Util.ownPropsAsArray(s).forEach(function (e) {
            ...
            if (this.id = e, this.dayNames = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], this.dayNamesShort = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], this.monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.datePattern = "M/d/yyyy", this.timePattern = "H:mm", this.dateTimePattern = "M/d/yyyy H:mm", this.timeFormat = "Clock12Hours", this.weekStarts = 0, t) for (var a in t) this[a] = t[a]
        ...
        DayPilot.Date = function (t, a) {
            ...
            var n = !1;
            if ("string" == typeof t) r = DayPilot.DateUtil.fromStringSortable(t, a).getTime(), n = !0; else if ("number" == typeof t) {
            ...
            var t = new Date(this.ticks), a = new Date(this.ticks), r = this.getYear() + e, o = this.getMonth();
            ...
            var e = new Date(this.ticks), t = e.getUTCMonth() + 1, a = e.getUTCFullYear(),
            ...
            var e = !1, t = this.dayOfYear(), a = this.firstDayOfYear().dayOfWeek(),
                r = this.firstDayOfYear().addYears(1).addDays(-1).dayOfWeek();
            0 === a && (a = 7), 0 === r && (r = 7);
            var o = 8 - a;
            4 !== a && 4 !== r || (e = !0);
            var n = Math.ceil((t - o) / 7), i = n;
        ...
        var a = function (e, t) {
            ...
            this.init = function () {
                ...
                var n = this.hours ? this.hours.findValue(e) : 0, i = this.minutes ? this.minutes.findValue(e) : 0,
                    d = this.seconds ? this.seconds.findValue(e) : 0, l = this.ampm ? this.ampm.findValue(e) : null;
        ...
        DayPilot.ColorUtil = {}, DayPilot.ColorUtil.hexToRgb = function (e) {
            ...
            t = t || 1;
            var r = 17, o = t * r, n = DayPilot.ColorUtil.adjustLuminance(a, -o);
            ...
            this.isEvent = !0, this.temp = function () {
                ...
                var t = {};
                if (t.value = this.id(), t.id = this.id(), t.text = this.text(), t.start = this.start(), t.end = this.end(), t.tag = {}, r.calendar && r.calendar.tagFields) for (var a = r.calendar.tagFields, o = 0; o < a.length; o++) t.tag[a[o]] = this.tag(a[o]);
                return t
            }
        }
    }
    ...
    function a(e, i) {
        ...
        switch (m && "object" == typeof m && "function" == typeof m.toJSON2 ? m = m.toJSON2(e) : m && "object" == typeof m && "function" == typeof m.toJSON && !m.ignoreToJSON && (m = m.toJSON(e)), "function" == typeof n && (m = n.call(i, e, m)), typeof m) {
            ...
            case"object":
                ...
                if (n && "object" == typeof n) for (u = n.length, d = 0; d < u; d += 1) l = n[d], "string" == typeof l && (s = a(l, m), s && c.push(t(l) + (r ? ": " : ":") + s)); else for (l in m) Object.hasOwnProperty.call(m, l) && (s = a(l, m), s && c.push(t(l) + (r ? ": " : ":") + s));
                return s = 0 === c.length ? "{}" : r ? "{\n" + r + c.join(",\n" + r) + "\n" + f + "}" : "{" + c.join(",") + "}", r = f, s
        }
    }
    ...
    "function" != typeof DayPilot.JSON.stringify && (DayPilot.JSON.stringify = function (e, t, i) {
        var d;
        if (r = "", o = "", "number" == typeof i) for (d = 0; d < i; d += 1) o += " "; else "string" == typeof i && (o = i);
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
        ...
        t.selectedCells = [], t.topSelectedCell = null, t.bottomSelectedCell = null, t.selecting = !1, t.column = null, t.firstSelected = null, t.firstMousePos = null, t.originalMouse = null, t.originalHeight = null, t.originalTop = null, t.resizing = null, t.globalHandlers = !1, t.moving = null, t.register = function (e) {
            ...
            if (t.resizing) {
                ...
                var n = t.resizing.event, s = t.resizingShadow.clientHeight + 4, a = t.resizingShadow.offsetTop,
            ...
            var i = t.movingShadow, n = i.parentNode;
            ...
            this.uniqueID = null, this.v = "2022.1.355-lite", this.id = e, this.clientName = e, this.cache = {}, this.cache.pixels = {}, this.elements = {}, this.elements.events = [], this.elements.selection = [], this.nav = {}, this.afterRender = function () {
            ...
            }, this.g = navigator && navigator.userAgent && navigator.userAgent.indexOf("MSIE") !== -1, this.h = navigator && navigator.userAgent && navigator.userAgent.indexOf("Firefox") !== -1, this.i = function () {
                ...
                return !1
            }(), this.cleanSelection = this.clearSelection, this.k = function (e, t, i) {
                var n = {};
                ...
                var e = s;
                e.p(), e.nav.scroll.root = null, DayPilot.pu(e.nav.loading), e.q(), e.r(), e.nav.select = null, e.nav.cornerRight = null, e.nav.scrollable = null, e.nav.zoom = null, e.nav.loading = null, e.nav.header = null, e.nav.hourTable = null, e.nav.scrolltop = null, e.nav.scroll = null, e.nav.main = null, e.nav.message = null, e.nav.messageClose = null, e.nav.top = null, t.unregister(e)
            }, this.s = function () {
            ...
            this.o = function (e, t) {
                ...
                if (s.p(), "Full" === e.UpdateType && (s.columns = e.Columns, s.days = e.Days, s.startDate = new DayPilot.Date(e.StartDate), s.heightSpec = e.HeightSpec ? e.HeightSpec : s.heightSpec, s.businessBeginsHour = e.BusinessBeginsHour ? e.BusinessBeginsHour : s.businessBeginsHour, s.businessEndsHour = e.BusinessEndsHour ? e.BusinessEndsHour : s.businessEndsHour, s.headerDateFormat = e.HeaderDateFormat ? e.HeaderDateFormat : s.headerDateFormat, s.viewType = e.ViewType, s.backColor = e.BackColor ? e.BackColor : s.backColor, s.eventHeaderVisible = e.EventHeaderVisible ? e.EventHeaderVisible : s.eventHeaderVisible, s.timeFormat = e.TimeFormat ? e.TimeFormat : s.timeFormat, s.locale = e.Locale ? e.Locale : s.locale, s.B()), e.Hashes) for (var i in e.Hashes) s.hashes[i] = e.Hashes[i];
                ...
                if (s.M()) {
                    ...
                    }, "function" == typeof s.onEventClick && (s.O.apply(function () {
                        s.onEventClick(n)
                    ...
                    "function" == typeof s.onEventClicked && s.O.apply(function () {
                        s.onEventClicked(n)
                    })
                ...
                if (s.M()) {
                    ...
                    if (t.e = e, t.control = s, t.preventDefault = function () {
                        this.preventDefault.value = !0
                    }, "function" == typeof s.onEventDelete && (s.O.apply(function () {
                        s.onEventDelete(t)
                    ...
                    "function" == typeof s.onEventDeleted && s.O.apply(function () {
                        s.onEventDeleted(t)
                    })
                ...
                if (s.M()) {
                    var p = {};
                    if (p.e = e, p.control = s, p.newStart = l, p.newEnd = o, p.preventDefault = function () {
                        this.preventDefault.value = !0
                    }, "function" == typeof s.onEventResize && (s.O.apply(function () {
                        s.onEventResize(p)
                    ...
                    "function" == typeof s.onEventResized && s.O.apply(function () {
                        s.onEventResized(p)
                    })
                ...
                var a = 1, l = Math.floor((i - a) / s.cellHeight), o = 30 * l * 60 * 1e3, r = e.start(), h = e.end(),
                    c = new Date;
                ...
                var d = r.getTime() - (c.getTime() + 3600 * r.getUTCHours() * 1e3 + 30 * Math.floor(r.getUTCMinutes() / 30) * 60 * 1e3),
                    u = h.getTime() - r.getTime(), v = this.columns[t], p = v.Start.getTime(), f = new Date;
                f.setTime(p + o + d);
                var g = new DayPilot.Date(f), m = g.addTime(u);
                if (s.M()) {
                    var y = {};
                    if (y.e = e, y.newStart = g, y.newEnd = m, y.ctrl = n.ctrlKey, y.shift = n.shiftKey, y.control = s, y.preventDefault = function () {
                        this.preventDefault.value = !0
                    }, "function" == typeof s.onEventMove && (s.O.apply(function () {
                        s.onEventMove(y)
                    }), y.preventDefault.value)) return;
                    switch (s.eventMoveHandling) {
                        ...
                        case"CallBack":
                            ...
                            break;
                        case"Update":
                            e.start(g), e.end(m), s.events.update(e)
                    }
                    "function" == typeof s.onEventMoved && s.O.apply(function () {
                        s.onEventMoved(y)
                    })
                ...
                if (e = new DayPilot.Date(e), t = new DayPilot.Date(t), this.M()) {
                    var i = {};
                    if (i.start = e, i.end = t, i.control = s, i.preventDefault = function () {
                        this.preventDefault.value = !0
                    }, "function" == typeof s.onTimeRangeSelect && (s.O.apply(function () {
                        s.onTimeRangeSelect(i)
                    ...
                    "function" == typeof s.onTimeRangeSelected && s.O.apply(function () {
                        s.onTimeRangeSelected(i)
                    })
                ...
                if (!t.selecting && "Disabled" !== s.timeRangeSelectedHandling) {
                    ...
                    if (1 === i || 0 === i) return t.firstMousePos = DayPilot.mc(e || window.event), t.selecting = {}, t.selecting.calendar = s, t.selectedCells && (s.clearSelection(), t.selectedCells = []), t.column = t.getColumn(this), t.selectedCells.push(this), t.firstSelected = this, t.topSelectedCell = this, t.bottomSelectedCell = this, s.R(), !1
                }
            }, this.R = function () {
                this.getSelection();
                !function () {
                    ...
                    if (a) {
                        var l = a.Start, o = s.getPixels(e.start, l).boxTop, r = s.getPixels(i.end, l).boxBottom,
                            h = r - o, c = function () {
                ...
                var e = t.topSelectedCell.start, i = t.bottomSelectedCell.end;
                return new DayPilot.Selection(e, i, null, s)
            }, this.T = function (e) {
            }, this.U = function (e) {
                if (e < 0) return null;
                ...
                this.columns = this.W();
                for (var e = 0; e < this.columns.length; e++) this.X(this.columns[e])
            }, this.X = function (e) {
                ...
                var e = this.columns.length - 1;
                return this.columns[e].Start.addDays(1)
            }, this.u = function (e) {
                ...
                if (l.setAttribute("unselectable", "on"), l.className = s.u("_event_inner"), l.innerHTML = e.client.html(), "darker" === i.borderColor && i.backColor ? l.style.borderColor = DayPilot.ColorUtil.darker(i.backColor, 2) : l.style.borderColor = i.borderColor, i.backColor && (l.style.background = i.backColor, (DayPilot.browser.ie9 || DayPilot.browser.ielt9) && (l.style.filter = "")), i.fontColor && (l.style.color = i.fontColor), a.appendChild(l), e.client.barVisible()) {
                    var o = e.part.height - 2, r = 100 * e.part.barTop / o, h = Math.ceil(100 * e.part.barHeight / o),
                ...
                if ("Disabled" !== s.eventDeleteHandling) {
                    ...
                    u.style.position = "absolute", u.style.right = "2px", u.style.top = "2px", u.style.width = "17px", u.style.height = "17px", u.className = s.u("_event_delete"), u.onmousedown = function (e) {
                        e.stopPropagation()
                ...
                for (var e = 0; e < this.columns.length; e++) {
                    ...
                    if (t.blocks) for (var i = 0; i < t.blocks.length; i++) for (var n = t.blocks[i], s = 0; s < n.lines.length; s++) for (var a = n.lines[s], l = 0; l < a.length; l++) {
                        var o = a[l];
                ...
                this.fasterDispose || DayPilot.pu(this.nav.hourTable), this.nav.scrollable.rows[0].cells[0].innerHTML = "", this.nav.hourTable = this.ca(), this.nav.scrollable.rows[0].cells[0].appendChild(this.nav.hourTable)
            }, this.ba = function () {
                var e = document.createElement("div");
                ...
                i = n.insertCell(-1), i.valign = "top", i.style.padding = "0px", i.style.border = "0px none", this.nav.hourTable = this.ca(), i.appendChild(this.nav.hourTable), i = n.insertCell(-1), i.valign = "top", i.width = "100%", i.style.padding = "0px", i.style.border = "0px none";
                var s = document.createElement("div");
                return s.style.position = "relative", i.appendChild(s), s.appendChild(this.da()), s.appendChild(this.ea()), e.appendChild(t), this.nav.zoom = e, e
            }, this.da = function () {
                ...
                for (var t = 24, i = 0; i < t; i++) this.fa(e, i);
                return e
            }, this.fa = function (e, t) {
                var i = 2 * this.cellHeight, n = e.insertRow(-1);
                n.style.height = i + "px";
                var s = n.insertCell(-1);
                s.valign = "bottom", s.unselectable = "on", s.style.cursor = "default", s.style.padding = "0px", s.style.border = "0px none";
                var l = document.createElement("div");
                l.style.position = "relative", l.className = this.u("_rowheader"), l.style.width = this.hourWidth + "px", l.style.height = i + "px", l.style.overflow = "hidden", l.unselectable = "on";
                var o = document.createElement("div");
                o.className = this.u("_rowheader_inner"), o.unselectable = "on";
                var r = document.createElement("div");
                r.unselectable = "on";
                var h = this.startDate.addHours(t), c = h.getHours(), d = c < 12, u = a.timeFormat();
                "Clock12Hours" === u && (c %= 12, 0 === c && (c = 12)), r.innerHTML = c;
                var v = document.createElement("span");
                v.unselectable = "on", v.className = this.u("_rowheader_minutes");
                var p;
                p = "Clock12Hours" === u ? d ? "AM" : "PM" : "00", v.innerHTML = p, r.appendChild(v), o.appendChild(r), l.appendChild(o), s.appendChild(l)
            }, this._ = function () {
                ...
                var e = document.createElement("div");
                e.style.position = "relative", e.className = this.u("_corner"), e.style.width = this.hourWidth + "px", e.style.height = this.headerHeight + "px", e.oncontextmenu = function () {
                    return !1
                };
                var t = document.createElement("div");
                ...
                for (var v = 0; v < n; v++) {
                    ...
                    for (var h = 0; h < l; h++) {
                        ...
                        c.start = p.Start.addTime(v * i), c.end = c.start.addTime(i), c.onmousedown = this.Q, c.onmouseup = function () {
                            return !1
                        }, c.onclick = function () {
                            return !1
                ...
                e.onmouseup = this.T, e.root = this, s.nav.scrollable.onmousemove = function (e) {
                    ...
                    if (t.resizing) {
                        ...
                        var n = DayPilot.mc(e || window.event), g = s.V.getCellCoords(), m = t.column,
                ...
                var t = "undefined" != typeof this.na.scrollpos ? this.na.scrollpos : this.initScrollPos;
                ...
                if (s.eventsLoadMethod && "POST" === s.eventsLoadMethod.toUpperCase()) DayPilot.Http.ajax({
                    "method": "POST",
                    "data": {"start": s.visibleStart().toString(), "end": s.visibleEnd().toString()},
                    "url": e,
                    "success": a,
                    "error": n
                }); else {
                ...
                s.ra(e), s.sa(), s.p(), s.nav.top.style.cursor = "auto";
                s.B(), s.E(), s.F(), s.G(), s.H(), s.ga(), s.ta(), s.C(), s.D(), s.A(), s.I(), s.clearSelection(), this.visible ? this.show() : this.hide()
            }, this.ua = null, this.ra = function (e) {
                if (e) {
                    var t = {
                        "events": {
                            "preInit": function () {
                ...
                if (s.xa.events = [], e) {
                    ...
                    if ("function" == typeof this.onBeforeEventRender) for (var a = 0; a < t; a++) this.ya(a);
                    for (var a = 0; a < this.columns.length; a++) {
                        var o = {};
                        o.minEnd = 1e6, o.maxStart = -1, this.scrollLabels.push(o);
                        var r = this.columns[a];
                        r.events = [], r.lines = [], r.blocks = [];
                        for (var h = new DayPilot.Date(r.Start), c = h.getTime(), d = h.addTime(i), u = d.getTime(), v = 0; v < t; v++) if (!n[v]) {
                            ...
                            if (!(m < g)) {
                                ...
                                if (y) {
                                    ...
                                    var C = this.getPixels(b.part.start, r.Start),
                                        w = this.getPixels(b.part.end, r.Start), D = C.top, S = w.top;
            ...
            }, this.O = {}, this.O.scope = null, this.O.notify = function () {
                s.O.scope && s.O.scope["$apply"]()
            }, this.O.apply = function (e) {
                e()
            }, this.ma = function () {
                ...
                var e = 0;
                s.na.scrollHour ? e = 2 * s.cellHeight * s.na.scrollHour : "Auto" === s.initScrollPos && (e = "BusinessHours" === this.heightSpec ? 2 * this.cellHeight * this.businessBeginsHour : 0), s.nav.scroll.scrollTop = e
            }, this.Ba = function () {
                ...
                this.sa(), this.B(), this.$(), this.E(), this.F(), this.oa(), this.la(), this.pa(), t.register(this), this.Da(), this.m("Init")
            }, this.na = {}, this.Ea = function () {
                this.na.themes = [], this.na.themes.push(this.theme || this.cssClassPrefix)
            }, this.Fa = function () {
                ...
                var e = s.Ja;
                e() || (s.Ka = setInterval(function () {
                    e() && (s.la(), s.oa(), clearInterval(s.Ka))
                }, 100))
            ...
            },this.internal = {},this.internal.xssTextHtml = s.La,this.init = function () {
                this.wa();
                var e = this.Ba();
                return this.Ea(), e ? void this.Ca() : (this.sa(), this.B(), this.C(), this.$(), this.E(), this.F(), this.A(), this.oa(), this.la(), this.pa(), t.register(this), this.events && (this.D(), this.I()), this.Ga(), this.Ha(), this.Da(), this.qa = !0, this)
            },this.Init = this.init,this.ra(i)
            ...
            e && e.directive("daypilotCalendar", ["$parse", function (e) {
                return {
                    "restrict": "E", "template": "<div></div>", "replace": !0, "link": function (t, i, n) {
                        ...
                        var r = t["$watch"], h = n["config"] || n["daypilotConfig"],
...
!function () {
    "undefined" != typeof DayPilot.DatePicker && DayPilot.DatePicker.close || (DayPilot.DatePicker = function (t) {
        this.v = "2022.1.355-lite";
        var e = "navigator_" + (new Date).getTime(), i = this;
        this.prepare = function () {
            if (this.locale = "en-us", this.target = null, this.resetTarget = !0, this.pattern = this.a.locale().datePattern, this.cssClassPrefix = "navigator_default", this.theme = null, this.patterns = [], t) for (var e in t) this[e] = t[e];
            this.init()
        }, this.init = function () {
            this.date = new DayPilot.Date(this.date);
            var t = this.b();
            this.resetTarget && !t && this.c(this.date), DayPilot.re(document, "mousedown", function () {
                i.close()
            })
        }, this.close = function () {
            ...
            var t = this.e(), a = this.navigator, a = new DayPilot.Navigator(e);
            a.api = 2, a.theme = i.theme || i.cssClassPrefix, a.weekStarts = "Auto", a.locale = i.locale, a.timeRangeSelectedHandling = "JavaScript", a.onTimeRangeSelected = function (t) {
                i.date = t.start;
                var e = t.start, a = e.toString(i.pattern, i.locale), t = {};
            ...
            var n = DayPilot.abs(t), o = t.offsetHeight, r = document.createElement("div");
            r.style.position = "absolute", r.style.left = n.x + "px", r.style.top = n.y + o + "px";
            var s = document.createElement("div");
            s.id = e, r.appendChild(s), DayPilot.re(r, "mousedown", function (t) {
    ...
    if (!DayPilot.ModalStatic) {
        ...
        a.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"), a.add(".modal_default_main:focus", "outline: none;"), a.add(".modal_default_content", "padding: 10px 0px;"), a.add(".modal_default_inner", "padding: 20px;"), a.add(".modal_default_input", "padding: 10px 0px;"), a.add(".modal_default_buttons", "margin-top: 10px;"), a.add(".modal_default_buttons", "padding: 10px 0px;"), a.add(".modal_default_form_item", "padding: 10px 0px; position: relative;"), a.add(".modal_default_form_item_level1", "border-left: 2px solid #ccc; margin-left: 10px; padding-left: 20px;"), a.add(".modal_default_form_item.modal_default_form_title", "font-size: 1.5rem; font-weight: bold;"), a.add(".modal_default_form_item input[type=text]", "width: 100%; box-sizing: border-box;"), a.add(".modal_default_form_item textarea", "width: 100%; height: 200px; box-sizing: border-box;"), a.add(".modal_default_form_item input[type=select]", "width: 100%; box-sizing: border-box;"), a.add(".modal_default_form_item label", "display: block;"), a.add(".modal_default_form_item select", "width: 100%; box-sizing: border-box;"), a.add(".modal_default_form_item_label", "margin: 2px 0px;"), a.add(".modal_default_form_item_image img", "max-width: 100%; height: auto;"), a.add(".modal_default_form_item_invalid", ""), a.add(".modal_default_form_item_invalid_message", "position: absolute; right: 0px; top: 9px; background-color: red; color: #ffffff; padding: 2px; border-radius: 2px;"), a.add(".modal_default_background", "opacity: 0.5; background-color: #000;"), a.add(".modal_default_ok", "padding: 3px; width: 80px;"), a.add(".modal_default_cancel", "padding: 3px; width: 80px;"), a.add(".modal_default_form_item_date", "position: relative;"), a.add(".modal_default_form_item_date:after", "content: ''; position: absolute; right: 7px; top: 50%; margin-top: 3px; width: 10px; height: 15px; background-image:url(" + "data:image/svg+xml;base64," + ")"), navigator.userAgent.indexOf("Edge") !== -1 && a.add(".modal_default_form_item_date input::-ms-clear", "display: none;"), a.add(".modal_default_form_item_scrollable_scroll", "width: 100%; height: 200px; box-sizing: border-box; border: 1px solid #ccc; overflow-y: auto;"), a.add(".modal_default_form_item_scrollable_scroll_content", "padding: 5px;"), a.add(".modal_default_form_item_searchable", "position: relative;"), a.add(".modal_default_form_item_searchable_icon", ""), a.add(".modal_default_form_item_searchable_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + "data:image/svg+xml;base64," + ");"), a.add(".modal_default_form_item_searchable_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"), a.add(".modal_default_form_item_searchable_list_item", "background: white; padding: 2px; cursor: default;"), a.add(".modal_default_form_item_searchable_list_item_highlight", "background: #ccc;"), a.add(".modal_default_form_item_tabular_main", "margin-top: 10px;"), a.add(".modal_default_form_item_tabular_table", "display: table; width: 100%; xbackground-color: #fff; border-collapse: collapse;"), a.add(".modal_default_form_item_tabular_tbody", "display: table-row-group;"), a.add(".modal_default_form_item_tabular_row", "display: table-row;"), a.add(".modal_default_form_item_tabular_row.modal_default_form_item_tabular_header", ""), a.add(".modal_default_form_item_tabular_cell.modal_default_form_item_tabular_rowaction", "padding: 0px; width: 23px;"), a.add(".modal_default_form_item_tabular_cell", "display: table-cell; border: 0px; padding: 2px 2px 2px 0px; cursor: default; vertical-align: bottom;"), a.add(".modal_default_form_item_tabular_header .modal_default_form_item_tabular_cell", "padding-left: 0px; padding-bottom: 0px;"), a.add(".modal_default_form_item_tabular_table input[type=text], .modal_default_form_item_tabular_table input[type=number]", "width:100%; box-sizing: border-box;"), a.add(".modal_default_form_item_tabular_table select", "width:100%; height:100%; box-sizing: border-box;"), a.add(".modal_default_form_item_tabular_plus", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), a.add(".modal_default_form_item_tabular_plus:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"), a.add(".modal_default_form_item_tabular_delete", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), a.add(".modal_default_form_item_tabular_delete:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"), a.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_plus", "display: none;"), a.add(".modal_default_form_item_tabular_plus_max.modal_default_form_item_tabular_plus", "display: none;"), a.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_delete", "visibility: hidden;"), a.add(".modal_default_form_item_tabular_empty", "height: 1px; margin: 5px 23px 5px 0px; background-color: #ccc;"), a.add(".modal_default_form_item_tabular_spacer .modal_default_form_item_tabular_cell", "padding: 0px;"), a.add(".modal_min_main", "border: 1px solid #ccc; max-width: 90%;"), a.add(".modal_min_background", "opacity: 0.5; background-color: #000;"), a.add(".modal_min_ok", "padding: 3px 10px;"), a.add(".modal_min_cancel", "padding: 3px 10px;"), a.add(".navigator_modal_main", "border-left: 1px solid #c0c0c0;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;background-color: white;color: #000000; box-sizing: content-box;"), a.add(".navigator_modal_main *, .navigator_modal_main *:before, .navigator_modal_main *:after", "box-sizing: content-box;"), a.add(".navigator_modal_month", "font-size: 11px;"), a.add(".navigator_modal_day", "color: black;"), a.add(".navigator_modal_weekend", "background-color: #f0f0f0;"), a.add(".navigator_modal_dayheader", "color: black;"), a.add(".navigator_modal_line", "border-bottom: 1px solid #c0c0c0;"), a.add(".navigator_modal_dayother", "color: gray;"), a.add(".navigator_modal_todaybox", "border: 1px solid red;"), a.add(".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright", "border-top: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;color: #333;background: #f3f3f3;"), a.add(".navigator_modal_busy", "font-weight: bold;"), a.add(".navigator_modal_cell", "text-align: center;"), a.add(".navigator_modal_select .navigator_modal_cell_box", "background-color: #FFE794; opacity: 0.5;"), a.add(".navigator_modal_title", "text-align: center;"), a.add(".navigator_modal_titleleft, .navigator_modal_titleright", "text-align: center;"), a.add(".navigator_modal_dayheader", "text-align: center;"), a.add(".navigator_modal_weeknumber", "text-align: center;"), a.add(".navigator_modal_cell_text", "cursor: pointer;"), a.commit(), DayPilot.Modal = function (e) {
            ...
            this.id = "_" + (new Date).getTime() + "n" + 10 * Math.random(), this.a = !1, this.b = null, this.c = null, this.showHtml = function (e) {
                ...
                }, 500), this.theme ? this.div.className = this.theme + "_main" : this.div.className = "", this.className && (this.div.className += " " + this.className), this.left ? this.div.style.left = this.left + "px" : this.div.style.marginLeft = "-" + Math.floor(this.width / 2) + "px", this.div.style.position = "absolute", this.div.style.boxSizing = "content-box", this.div.style.top = a + this.top + "px", this.div.style.width = this.width + "px", this.zIndex && (this.div.style.zIndex = this.zIndex), this.height && (this.useIframe || !this.autoStretch ? this.div.style.height = this.height + "px" : this.div.style.height = ""), this.useIframe && this.height && (this.iframe.style.height = this.height + "px"), this.div.style.display = "", this.l(), DayPilot.ModalStatic.remove(this), DayPilot.ModalStatic.list.push(this)
            }, this.h = function () {
                ...
                var e = t.z.container(), i = e === document.body, a = i ? "fixed" : "absolute",
                ...
                var o = document.createElement("div");
                o.id = this.id + "popup", o.style.position = a, o.style.left = "50%", o.style.top = "0px", o.style.backgroundColor = "white", o.style.width = "50px", o.style.height = "50px", this.dragDrop && (o.onmousedown = this.t), o.addEventListener("keydown", function (e) {
                    e.stopPropagation()
                });
                var l = null;
                ...
                n.document && (n = n.document), null == n.body && n.write("<body></body>"), i.nodeType ? n.body.appendChild(i) : n.body.innerHTML = i, t.autoStretch && (t.autoStretchFirstLoadOnly && t.A || (t.stretch(), t.A = !0))
            ...
            return DayPilot.getPromise(function (a, n) {
                ...
                var o = new DayPilot.Modal(t), l = document.createElement("div");
                ...
                s.innerText = i, s.className = o.theme + "_ok", s.onclick = function (e) {
            ...
            return DayPilot.getPromise(function (n, o) {
                ...
                var l = new DayPilot.Modal(t), d = document.createElement("div");
                ...
                c.innerText = i, c.className = l.theme + "_ok", c.onclick = function (e) {
                    DayPilot.ModalStatic.close("OK")
                };
                var u = document.createTextNode(" "), m = document.createElement("button");
                m.innerText = a, m.className = l.theme + "_cancel", m.onclick = function (e) {
            ...
            return DayPilot.getPromise(function (t, l) {
                ...
                h.innerText = a, h.className = d.theme + "_ok", h.onclick = function (e) {
                    d.close(u.value)
                };
        ...
        DayPilot.Modal.form = function (t, i, a) {
            ...
            return DayPilot.getPromise(function (a, n) {
                ...
                f.innerText = c, f.className = l.theme + "_ok", s.okDisabled && (f.disabled = !0), f.onclick = function (e) {
                    m.validate() && l.close(m.serialize())
                };
                var v = document.createTextNode(" "), g = document.createElement("button");
                if (g.innerText = u, g.className = l.theme + "_cancel", g.onclick = function (e) {
                    l.close()
                }, g.onmousedown = function (e) {
                    m.canceling = !0
                }, p.appendChild(f), p.appendChild(v), p.appendChild(g), d.appendChild(r), d.appendChild(p), l.showHtml(d), l.div.setAttribute("tabindex", "-1"), l.div.addEventListener("keydown", function (e) {
                    switch (e.keyCode) {
                        case 27:
                            l.close();
                            break;
        ...
        }, DayPilot.Modal.Experimental = {}, DayPilot.Modal.Experimental.Form = o, "undefined" == typeof DayPilot.getPromise && (DayPilot.getPromise = function (e) {
        ...
        o.prototype.create = function () {
            ...
            o.onInput = function (e) {
                ...
                i.canceling || i.I(o)
            }, o.apply(e), o.H = a, o.row = e, o.element && a.appendChild(o.element), this.G.push(o), this.H.appendChild(a)
        }, o.prototype.validate = function () {
            var e = this, t = !0;
            return this.G.forEach(function (i) {
                var a = e.I(i);
                t = t && a
            }), t
            ...
            t = t || {};
            var a = t.debounce, n = t.silent, o = e.row, l = !0,
                d = "function" == typeof o.data.onValidate ? o.data.onValidate : null,
                r = "function" == typeof o.data.validate ? o.data.validate : null, s = d || r;
            if (s) {
                var c = {};
                ...
                if (c.valid) clearTimeout(this.F[o.field]), e.J && (e.J.remove(), e.J = null), e.H.classList.remove(u); else if (!n) if (a) {
                    var h = 1e3;
            ...
            if ("radio" === a) {
                ...
                e.options.forEach(function (o) {
                    var d = new l;
                    d.field = e.id, d.data = o, d.level = t, d.type = a, d.isValue = !0, d.text = o.name, d.resolved = o.id, i.D.push(d), n.push(d), o.children && o.children.forEach(function (e) {
            ...
            var t = this, i = {
                "label": function () {
                    ...
                    n.type = "radio", n.name = e.field, n.K = e.resolved, n.onchange = function (e) {
                        var a = i.row;
                    ...
                    var a = document.createElement("label"), n = document.createElement("input");
                    n.type = "checkbox", n.name = e.field, n.K = e.resolved, n.onchange = function (e) {
                        var a = i.row;
            ...
            return ["text", "date", "select", "searchable", "radio", "checkbox", "table", "title", "image", "html", "textarea", "scrollable"].indexOf(e.type) !== -1 ? e.type : e.type && this.plugins && this.plugins[e.type] ? e.type : e.image ? "image" : e.html || e.text ? "html" : e.id ? e.options ? "searchable" : e.dateFormat ? "date" : e.columns ? "table" : "text" : "title"
        ...
        r.prototype.select = function (e) {
            return this.M = this.data.find(function (t) {
                return t.id === e
            }), this.U(!1), this
        }, r.prototype.create = function () {
            function e() {
                m.style.display = "", m.style.top = p.offsetHeight + "px", m.style.left = "0px", m.style.width = p.offsetWidth + "px", m.innerHTML = "", m.addEventListener("mousedown", function (e) {
                    e.preventDefault()
                }), r.N = null, r.R = [];
                var e = null;
                r.data.forEach(function (i) {
                    ...
                    if (n.toLowerCase().indexOf(p.value.toLowerCase()) !== -1) {
                        var o = document.createElement("div");
                        o.className = r.theme + "_list_item", o.innerText = n, o.item = i, i === r.M && (r.N = o), e || (e = o), o.addEventListener("mousedown", function (e) {
                            a(o), e.preventDefault()
                        }), o.addEventListener("mousemove", function (e) {
                            r.N !== o && (r.N = o, t({dontScroll: !0}))
                        }), m.appendChild(o), r.R.push(o)
                    }
                }), r.N || (r.N = e), t()
            }
            ...
            return p.type = "text", p.className = this.theme + "_input", p.disabled = this.L, p.addEventListener("click", function (e) {
                d()
        ...
        s.prototype.create = function () {
            ...
            this.disabled ? this.nav.main.classList.add(this.theme + "_disabled") : this.nav.main.classList.remove(this.theme + "_disabled"), this.aa() ? this.nav.plus.classList.add(this.theme + "_plus_max") : this.nav.plus.classList.remove(this.theme + "_plus_max")
...
"undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function () {
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
        ...
        t.Month = function (e, i) {
            this.v = "2022.1.355-lite", this.nav = {};
            var n = this;
            this.id = e, this.isMonth = !0, this.api = 2, this.backendUrl = null, this.cellHeaderHeight = 24, this.cellHeight = 100, this.cssClassPrefix = "month_default", this.eventHeight = 25, this.eventsLoadMethod = "GET", this.headerHeight = 30, this.hideUntilInit = !0, this.lineSpace = 1, this.locale = "en-us", this.showToolTip = !0, this.startDate = new DayPilot.Date, this.theme = null, this.visible = !0, this.weekStarts = 1, this.width = "100%", this.xssProtection = "Enabled", this.afterRender = function () {
                ...
                t.calendar = n, n.events.list || (n.events.list = []), n.events.list.push(t.data), n.update(), n.j.notify()
            }, this.events.update = function (t) {
                t.commit(), n.update(), n.j.notify()
                ...
                if (t) {
                    ...
                    for (var i = 0; i < t.length; i++) {
                        var n = t[i];
                        if (n.start = new DayPilot.Date(n.start), n.end = new DayPilot.Date(n.end), !(n.start.getTime() > n.end.getTime())) for (var e = 0; e < this.rows.length; e++) {
                    ...
                    for (var l = 0; l < this.rows.length; l++) {
                        ...
                        for (var o = 0; o < this.rows[l].events.length; o++) {
                            var r = s.events[o], h = s.getStartColumn(r), c = s.getWidth(r);
                            s.putIntoLine(r, h, c, l)
                        }
                    }
                }
            }, this.b = function () {
                ...
                for (t.resizingEvent ? c = "w-resize" : t.movingEvent && (c = "move"), this.nav.top.style.cursor = c; o > 0 && i < this.rows.length;) {
                    var d = Math.min(this.getColCount() - e, o), v = this.rows[i], u = this.getRowTop(i),
                        f = v.getHeight(), p = document.createElement("div");
                ...
                var i = e.cache || e.data, s = e.part.row, a = e.part.line, l = e.part.colStart, o = e.part.colWidth,
                    r = this.getCellWidth() * l, h = this.getCellWidth() * o, c = this.getEventTop(s, a),
                    d = document.createElement("div");
                d.setAttribute("unselectable", "on"), d.style.height = this.eventHeight + "px", d.className = this.u("_event"), i.cssClass && DayPilot.Util.addClass(d, i.cssClass), d.event = e, d.style.width = h + "%", d.style.position = "absolute", d.style.left = r + "%", d.style.top = c + "px", this.showToolTip && e.client.toolTip() && (d.title = e.client.toolTip()), d.onclick = n.w, d.onmousedown = function (i) {
                    i = i || window.event;
                    var r = i.which || i.button;
                    if (i.cancelBubble = !0, i.stopPropagation && i.stopPropagation(), 1 === r) if (t.movingEvent = null, "w-resize" === this.style.cursor || "e-resize" === this.style.cursor) {
                        var h = {};
                        ...
                        var v = n.getCellBelowPoint(c.x, c.y),
                            u = DayPilot.DateUtil.daysDiff(e.start(), n.rows[s].start), f = 7 * v.y + v.x - (7 * s + l);
                        u && (f += u);
                        var p = {};
                    ...
                    if ("undefined" != typeof t && !t.movingEvent && !t.resizingEvent) {
                        var s = DayPilot.mo3(d, i);
                        if (s) {
                            d.deleteIcon && (d.deleteIcon.style.display = "");
                            var a = 6;
                            s.x <= a && "Disabled" !== n.eventResizeHandling ? e.part.startsHere ? (d.style.cursor = "w-resize", d.dpBorder = "left") : d.style.cursor = "not-allowed" : d.clientWidth - s.x <= a && "Disabled" !== n.eventResizeHandling ? e.part.endsHere ? (d.style.cursor = "e-resize", d.dpBorder = "right") : d.style.cursor = "not-allowed" : d.style.cursor = "default"
                        }
                    }
                ...
                if (v.setAttribute("unselectable", "on"), v.className = this.u("_event_inner"), "darker" === i.borderColor && i.backColor ? v.style.borderColor = DayPilot.ColorUtil.darker(i.backColor, 2) : v.style.borderColor = i.borderColor, i.backColor && (v.style.background = i.backColor, (DayPilot.browser.ie9 || DayPilot.browser.ielt9) && (v.style.filter = "")), i.fontColor && (v.style.color = i.fontColor), v.innerHTML = e.client.html(), d.appendChild(v), "Disabled" !== n.eventDeleteHandling) {
                    var u = Math.floor(n.eventHeight / 2 - 9), f = document.createElement("div");
                    f.style.position = "absolute", f.style.right = "2px", f.style.top = u + "px", f.style.width = "18px", f.style.height = "18px", f.className = n.u("_event_delete"), f.onmousedown = function (t) {
                        t.stopPropagation()
                    }, f.onclick = function (t) {
                        t.stopPropagation();
                        var e = this.parentNode.event;
                        e && n.z(e)
                    }, f.style.display = "none", d.deleteIcon = f, d.appendChild(f)
                }
                ...
                for (var s = 0; s < t; s++) {
                    var a = {};
                    a.start = this.firstDate.addDays(7 * s), a.end = a.start.addDays(this.getColCount()), a.events = [], a.lines = [], a.index = s, a.minHeight = this.cellHeight, a.calendar = this, a.belongsHere = function (t) {
                        ...
                        return l.isFree = function (t, e) {
                            ...
                            t.part.colStart = e, t.part.colWidth = i, t.part.row = n, t.part.line = a, t.part.startsHere = s.start.getTime() <= t.start().getTime(), t.part.endsHere = s.end.getTime() >= t.end().getTime(), this.push(t)
                ...
                this.nav.events = s, s.style.position = "absolute", s.style.left = "0px", s.style.right = "0px", s.setAttribute("unselectable", "on"), e.appendChild(s), e.onmousemove = function (e) {
                    if (t.resizingEvent) {
                        ...
                        t.timeRangeSelecting.from = {
                            x: f.x,
                            y: f.y
                        }, t.timeRangeSelecting.width = a, t.timeRangeSelecting.moved = !0, n.drawShadow(f.x, f.y, 0, a, 0, null)
                    }
                }
            }, this.h = function () {
                ...
                c.setAttribute("unselectable", "on"), r.appendChild(c), c.style.position = "absolute", c.style.left = "0px", c.style.right = "0px", c.style.top = "0px", c.style.bottom = "0px", c.className = this.u("_cell_inner"), r.onmousedown = function (s) {
                    ...
                    var t = function (t) {
                        var e = new DayPilot.Date(t), i = e.addDays(1);
                        n.D(e, i)
                    };
                ...
                c = c.addDays(-s);
                var d = DayPilot.DateUtil.daysSpan(t.start(), t.end()) + 1, v = c.addDays(d), u = c.addTime(o),
                    f = v.addTime(h);
                if (n.C()) {
                    var p = {};
                ...
                var l = DayPilot.DateUtil.diff(t.end(), a), o = this.getDateFromCell(e.x, e.y), r = o.addDays(i),
                    h = o.addTime(s), c = r.addTime(l);
                if (n.C()) {
                    var d = {};
            ...
            }, this.internal = {}, this.internal.xssTextHtml = n.P, this.init = function () {
                return this.N(), this.loadFromServer() ? void this.O() : (this.c(), this.d(), this.A(), this.g(), this.m(), this.i(), this.M(), this.messageHTML && this.message(this.messageHTML), void this.fireAfterRenderDetached(null, !1))
            }, this.Init = this.init, this.l(i)
            ...
            if (t.movingEvent) {
                ...
                var n = t.movingEvent.event.calendar, s = t.movingEvent.event, a = n.shadow.start,
                    l = n.shadow.position, o = t.movingEvent.offset;
            ...
            if (t.resizingEvent) {
                ...
                if (!i.event.calendar.shadow) return;
                if (!i.event.calendar.shadow.start) return;
                var n = t.resizingEvent.event.calendar, s = t.resizingEvent.event, a = n.shadow.start,
                    r = n.shadow.width;
            ...
            if (t.timeRangeSelecting) {
                if (t.timeRangeSelecting.moved) {
                    var h = t.timeRangeSelecting, n = h.root,
                        a = new DayPilot.Date(n.getDateFromCell(h.from.x, h.from.y)), c = a.addDays(h.width);
                    n.D(a, c), n.clearShadow()
                }
            ...
            t && t.directive("daypilotMonth", ["$parse", function (t) {
                return {
                    "restrict": "E", "template": "<div></div>", "replace": !0, "link": function (e, i, n) {
                        ...
                        var r = e["$watch"], h = n["config"] || n["daypilotConfig"],
                            c = n["events"] || n["daypilotEvents"];
    ...
    if ("undefined" == typeof DayPilot.Navigator || !DayPilot.Navigator.nav) {
        DayPilot.Navigator = function (t, e) {
            ...
            this.id = t, this.api = 2, this.isNavigator = !0, this.autoFocusOnClick = !0, this.weekStarts = "Auto", this.selectMode = "day", this.titleHeight = 30, this.dayHeaderHeight = 30, this.bound = null, this.cellWidth = 30, this.cellHeight = 30, this.cssClassPrefix = "navigator_default", this.freeHandSelectionEnabled = !1, this.selectionStart = (new DayPilot.Date).getDatePart(), this.selectionEnd = null, this.selectionDay = null, this.showMonths = 1, this.skipMonths = 1, this.command = "navigate", this.year = (new DayPilot.Date).getYear(), this.month = (new DayPilot.Date).getMonth() + 1, this.showWeekNumbers = !1, this.weekNumberAlgorithm = "Auto", this.rowsPerMonth = "Six", this.orientation = "Vertical", this.locale = "en-us", this.rtl = !1, this.visible = !0, this.timeRangeSelectedHandling = "Bind", this.visibleRangeChangedHandling = "Enabled", this.onVisibleRangeChange = null, this.onVisibleRangeChanged = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.nav = {}, this.a = {}, this.b = function () {
                ...
                var n = this.startDate.addMonths(t), l = e.before, o = e.after, h = n.firstDayOfMonth(),
                    r = h.firstDayOfWeek(a.weekStarts()), c = h.addMonths(1), d = DayPilot.DateUtil.daysDiff(r, c),
                ...
                s.height = p;
                var v = document.createElement("div");
                if (v.style.width = y + "px", v.style.height = p + "px", "Horizontal" === this.orientation) v.style.position = "absolute", v.style.left = y * t + "px", v.style.top = "0px", s.top = 0, s.left = y * t; else {
                ...
                var w = this.d();
                if (this.showWeekNumbers) for (var k = 0; k < u; k++) {
                ...
                for (var M = 0; M < 7; M++) {
                    ...
                    for (var k = 0; k < u; k++) {
                        var S = r.addDays(7 * k + M), P = this.m(S) && "none" !== this.n(),
                            E = S.firstDayOfMonth() === n, N = S < n, W = S >= n.addMonths(1);
                        if ("month" === this.n()) P = P && E; else if ("day" === this.n()) P = P && (E || l && N || o && W); else if ("week" === this.n()) {
                ...
                var i = this.titleHeight + this.dayHeaderHeight, s = this.d();
                ...
                if (this.items) for (var t = 0; t < this.showMonths; t++) for (var e = 0; e < 7; e++) for (var i = 0; i < 6; i++) {
                ...
                if (!this.z) return void (this.w = {"date": t, "options": e});
                var i = !0, s = !0;
                ...
                for (var l = 0; l < n.cells.length; l++) for (var o = 0; o < n.cells[l].length; o++) {
            ...
            s.start = null, s.drawCell = function (t) {
                var e = i.months[t.month], n = i.o(t.x, t.y), a = e.top + n.y, l = e.left + n.x,
            ...
            var n = function (t, e, s) {
                ...
                this.is = function (t) {
                    ...
                    return t.y < e.rowCount - 1 ? {
                        ...
                        "x": 0,
                        "y": t.y + 1
                    } : t.month < i.months.length - 1 ? {"month": t.month + 1, "x": 0, "y": 0} : null
            ...
            this.p = function (t) {
                ...
                if (s.cells[n][a].isClickable) {
                    ...
                    switch (i.n()) {
                        ...
                        case"month":
                            ...
                            for (var o = null, r = null, a = 0; a < 6; a++) for (var n = 0; n < 7; n++) {
                                var h = s.cells[n][a];
                ...
                var e = i.selectionStart, s = i.selectionEnd.addDays(1), n = DayPilot.DateUtil.daysDiff(e, s),
                    a = i.selectionDay;
                if (t = t || {}, i.e()) {
                    var l = {};
            ...
            t && t.directive("daypilotNavigator", ["$parse", function (t) {
                return {
                    "restrict": "E", "template": "<div id='{{id}}'></div>", "compile": function (e, i) {
                        return e.replaceWith(this["template"].replace("{{id}}", i["id"])), function (e, i, s) {
                            ...
                            for (var o in s) if (0 === o.indexOf("on")) {
                            ...
                            var r = e["$watch"], c = s["config"] || s["daypilotConfig"],
